    ...
    return (
        <div className={'flex w-full animate-fade flex-col gap-2'}>
            <div className={'flex w-full justify-between'}>
                ...
                <select disabled={true} name={'designColor'} className={'w-full rounded-md p-1'}>
            ...
            <div className={'flex items-center'}>
                ...
                <input disabled={true} name={'notificationToggle'} type={'checkbox'}/>
            </div>
            <div className={'flex items-center'}>
                <p className={'w-[150px] text-gray-600'}>{useTranslate('SettingsDesignPosition')}</p>
                <select disabled={true} name={'notificationsPosition'} className={'w-full rounded-md p-1'}>
                    <option>Standart</option>
